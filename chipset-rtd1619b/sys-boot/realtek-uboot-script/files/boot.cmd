...
setenv linux_image_its /boot/vmlinuz
...
setenv bootargs "earlycon=uart8250,mmio32,0x98007800 console=ttyS0,460800 uio_pdrv_genirq.of_id=generic-uio firmware_class.path=/lib/firmware/realtek/rtd1619b/ pd_ignore_unused clk_ignore_unused rootfstype=ext2 rootwait ro cros_debug cros_secure root=PARTUUID=${root_uuid} ${extra_bootargs}"
