...
setenv bootargs "earlycon=uart8250,mmio32,0x98007800 console=ttyS0,460800 uio_pdrv_genirq.of_id=generic-uio firmware_class.path=/lib/firmware/realtek/rtd1625/ pd_ignore_unused clk_ignore_unused rootfstype=ext2 rootwait ro cros_debug cros_legacy root=PARTUUID=${root_uuid} ${extra_bootargs}"
setenv kernel_addr_c 0x01200000
