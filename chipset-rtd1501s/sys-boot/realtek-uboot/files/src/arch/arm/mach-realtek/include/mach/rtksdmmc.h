...
struct rtk_sdmmc_host {
    ...
    struct mmc_host *mmc;
    uintptr_t sdmmc_base;
    uintptr_t crt_base;
    uintptr_t sysbrdg;
    uintptr_t isopad_base;
    uintptr_t gpiodir_base;
    u8 cmd_opcode;
    u32 mclk;
    u32 signal_voltage;
};
...
#define GPIODIR_OFFSET 0xc4
#define ISOPAD_OFFSET 0x78
#define ISOPAD_DRV_OFF_MSK_1 0xfbffdffe
#define ISOPAD_DRV_OFF_MSK_2 0xffffff7f
#define ISOPAD_DRV_OFF_MSK_3 0xffffdffe
#define ISOPAD_DRV_ON_MSK_1 0xfe07f03f
#define ISOPAD_DRV_ON_MSK_2 0xfff81fc0
#define ISOPAD_DRV_ON_MSK_3 0xfe07f03f
#define ISOPAD_DRV_ON_VAL_1 0x00d806c0
#define ISOPAD_DRV_ON_VAL_2 0x0003601b
#define ISOPAD_DRV_ON_VAL_3 0x00d806c0
#define CR_PLL_SD2_V 0x0451942d
#elif defined(CONFIG_TARGET_RTD1319)
#define GPIODIR_OFFSET 0x64
#define ISOPAD_OFFSET 0x4c
#define ISOPAD_DRV_OFF_MSK_1 0xffffeffe
#define ISOPAD_DRV_OFF_MSK_2 0xfffeffef
#define ISOPAD_DRV_OFF_MSK_3 0xffffeffe
#define ISOPAD_DRV_ON_MSK_1 0xff000000
#define ISOPAD_DRV_ON_MSK_2 0xf000000f
#define ISOPAD_DRV_ON_MSK_3 0xff000000
#define ISOPAD_DRV_ON_VAL_1 (0x003003)
#define ISOPAD_DRV_ON_VAL_2 (0x003003<<4)
#define ISOPAD_DRV_ON_VAL_3 (0x003003)
#define CR_PLL_SD2_V 0x04519893
#endif
