...
#define RSA_CTRL1				(RSA_REG_BASE  + 0x000)

#define RSA_CTRL3				(RSA_REG_BASE  + 0x008)
#define RSA_CTRL4				(RSA_REG_BASE  + 0x00c)
...
/* The definition structure for smc command do hwrsa. */
typedef enum rsa_key_sel {
	NORMAL_KEY = 0,
	CONST_KEY1,
	CONST_KEY2,
	CONST_KEY3,
...
typedef struct rsa_key {
	rsa_key_sel_t type;
	void *key; // points to rsa key if type is NORMAL_KEY, otherwise should be NULL
} rsa_key_t;
