...
/* HOST Setting */
#define USB_HOST_NUM 3 // xhci_u2drd, xhci_u2host, xhci_u3drd

#define USB_HOST0_ENABLE 1 // xhci_u2drd
...
#define USB_HOST2_ENABLE 1 // xhci_u3drd
...
/* Device Setting */
#define USB_DEVICE_NUM 2 /* number for all device controllers */

#define USB_DEVICE0_ENABLE 0
...
#define USB_DEVICE0_IRQ_NUM 127

#define USB_DEVICE1_ENABLE 1
#define USB_DEVICE1_CTRL_ID 2
#define USB_DEVICE1_TYPE DWC3_XHCI
#define USB_DEVICE1_WRAP_ADDR 0x98013E00
#define USB_DEVICE1_ADDR 0x98050000
#define USB_DEVICE1_IRQ_NUM 126
...
void rtk_usb_power_on(int port);
