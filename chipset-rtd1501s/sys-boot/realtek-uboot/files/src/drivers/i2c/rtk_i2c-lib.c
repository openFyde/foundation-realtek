...
#define I2C0_REG        0x9804E008
#define I2C0_MUX_MASK   ~(0x00000040|0x00000080)
#define I2C0_MUX_EN     (0x00000040&((0x1)<<6))|(0x00000080&((0x1)<<7))

#define I2C1_REG        0x9804E008
#define I2C1_MUX_MASK   ~(0x00002000|0x00006000)
#define I2C1_MUX_EN     (0x00002000&((0x1)<<13))|(0x00006000&((0x1)<<14))

#define I2C2_REG        0
#define I2C2_MUX_MASK   0
#define I2C2_MUX_EN     0

#define I2C3_REG        0x9804E018
#define I2C3_MUX_MASK   ~(0x000000C0|0x00000300)
#define I2C3_MUX_EN     (0x000000C0 &((0x2)<<6))|(0x00000300 & ((0x2)<<8))

#define I2C4_REG_1      0x9804E00C
#define I2C4_MUX_MASK_1 ~(0x03800000)
#define I2C4_MUX_EN_1   (0x03800000 &((0x5)<<23))

#define I2C4_REG_2      0x9804E00C
#define I2C4_MUX_MASK_2 ~(0x1C000000)
#define I2C4_MUX_EN_2   (0x1C000000 &((0x5)<<26))

#define I2C5_REG_1      0x9804E00C
#define I2C5_MUX_MASK_1     ~(0x00000100)
#define I2C5_MUX_EN_1       (0x00000100 & ((0x1)<<8))

#define I2C5_REG_2      0x9804E010
#define I2C5_MUX_MASK_2     ~(0x80000000)
#define I2C5_MUX_EN_2       (0x80000000 & ((0x1)<<31))
...
#define I2C1_REG		0x9804E008
#define I2C1_MUX_MASK	~(0x00000400|0x00000800)
#define I2C1_MUX_EN		(0x00000400&((0x1)<<10))|(0x00000800&((0x1)<<11))

#define I2C2_REG	0
#define I2C2_MUX_MASK	0
#define I2C2_MUX_EN	0

#define I2C3_REG		0x9804E014
#define I2C3_MUX_MASK	~(0x00006000|0x00018000)
#define I2C3_MUX_EN		(0x00006000 &((0x2)<<13))|(0x00018000 & ((0x2)<<15))

#define I2C4_REG_1		0x0
#define I2C4_MUX_MASK_1		0x0
#define I2C4_MUX_EN_1		0x0

#define I2C4_REG_2		0x0
#define I2C4_MUX_MASK_2		0x0
#define I2C4_MUX_EN_2		0x0

#define I2C5_REG_1             0x9804E00C
#define I2C5_MUX_MASK_1                ~(0x00000002)
#define I2C5_MUX_EN_1          (0x00000002 & ((0x1)<<1))

#define I2C5_REG_2             0x9804E010
#define I2C5_MUX_MASK_2                ~(0x00030000)
#define I2C5_MUX_EN_2          (0x00030000 & ((0x1)<<16))
...
void I2CN_Init(int Bus_ID)
{
	...
	case 5:
#if 1
		rtd_maskl(I2C5_REG_1, I2C5_MUX_MASK_1, I2C5_MUX_EN_1);
		rtd_maskl(I2C5_REG_2, I2C5_MUX_MASK_2, I2C5_MUX_EN_2);
#else
...
void I2CN_UnInit(int Bus_ID)
{
	...
	case 5:
#if 1
		rtd_maskl(I2C5_REG_1, I2C5_MUX_MASK_1, 0);
		rtd_maskl(I2C5_REG_2, I2C5_MUX_MASK_2, 0);
#else
