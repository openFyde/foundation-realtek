...
#if defined(CONFIG_TARGET_RTD1619B)
	reg = readl_relaxed(isopad_base+0xc);
	reg &= 0xe0001fff;
	writel_relaxed(reg | 0x04842000, isopad_base+0xc);

	reg = readl_relaxed(isopad_base+0x10);
	reg &= 0xfff80000;
	writel_relaxed(reg | 0x00004421, isopad_base+0x10);
